...
import { verifyAllUnlockedBadges } from "@/lib/badge-verification";
...
export async function awardXp(firebaseUid, actionType, metadata = {}) {
  ...
  while (attempt < MAX_RETRIES) {
    ...
    const newlyUnlockedCandidates = calculateUnlockedBadges(studentData);

    // Verify all badge requirements before awarding
    const newlyUnlocked = verifyAllUnlockedBadges(newlyUnlockedCandidates, studentData);
