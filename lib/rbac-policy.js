...
const API_ROUTE_RULES = [
  { pattern: /^\/api\/exceptions\/update(?:\/|$)/, roles: ["teacher", "admin", "institute"] },
  { pattern: /^\/api\/exceptions\/all(?:\/|$)/, roles: ["teacher", "admin", "institute"] },
  { pattern: /^\/api\/exceptions\/list(?:\/|$)/, roles: ["student", "teacher", "admin", "institute"] },
  { pattern: /^\/api\/exceptions\/create(?:\/|$)/, roles: ["student", "admin"] },
