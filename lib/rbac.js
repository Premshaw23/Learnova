...
const API_ROUTE_RULES = [
  ...
  { pattern: /^\/api\/exceptions\/create(?:\/|$)/, roles: ["student"] },
  { pattern: /^\/api\/exceptions\/list(?:\/|$)/, roles: ["admin", "teacher", "student"] },
  { pattern: /^\/api\/exceptions\/all(?:\/|$)/, roles: ["admin", "teacher"] },
  { pattern: /^\/api\/exceptions\/update(?:\/|$)/, roles: ["admin", "teacher"] },
