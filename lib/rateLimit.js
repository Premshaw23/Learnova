...
// Redis initialization is centralized in lib/redis.js
...
export async function checkRateLimit(userId) {
  ...
  try {
    ...
    if (logger?.error) logger.error("Rate Limiter: Redis failed, tripping Circuit Breaker", { error: errMsg, userId });
