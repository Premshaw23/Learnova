 ...
 * Retries fetch on failure rather than returning stale null values.
 */
async function getFirebasePublicKeys() {
  ...
  try {
    ...
    console.error("[firebase-keys] Failed to fetch public keys:", error);
    // Return cached data if available, otherwise empty object (not null)
    // to allow fallback to identitytoolkit REST API
    return cachedPublicKey || {};
  }
}
