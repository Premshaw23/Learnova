                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="absolute -top-20 flex flex-col items-center">
                          ...
                          <div
                            className={`w-16 h-16 sm:w-20 sm:h-20 flex items-center justify-center text-3xl sm:text-4xl bg-gray-800 rounded-full border-4 ${
                              style.border
                            } shadow-lg mb-2 z-10 ${
                              isFirst ? "scale-110" : ""
                            } overflow-hidden`}
                    ...
                    <div className="flex flex-col">
                      {restOfList.map((user, index) => (
                        <motion.div
                          ...
                          className={`group grid grid-cols-12 gap-2 sm:gap-4 px-4 sm:px-6 py-4 items-center border-b border-white/5 hover:bg-white/5 transition-colors ${
                            (user.name && user.name.includes("You")) ||
                            user.isCurrentUser
