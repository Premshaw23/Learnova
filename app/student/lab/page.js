...
import Interactive3DModel from "@/components/Lab/Interactive3DModel";
      ...
      <div className="flex-1 max-w-7xl mx-auto w-full p-4 md:p-6 lg:p-8 flex flex-col gap-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-zinc-900/40 p-6 rounded-3xl border border-zinc-800 backdrop-blur-xl">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-zinc-400">
                Interactive physics simulations to visualize textbook theories.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-2 bg-zinc-950 p-1.5 rounded-xl border border-zinc-800 w-full md:w-auto">
            ...
            >
              <Box className="w-4 h-4" /> 3D Models
            </button>
          </div>
        </div>
          ...
          <div className="lg:col-span-2 bg-[#0c0c0e] border border-zinc-800 rounded-3xl p-6 relative flex flex-col justify-center min-h-[450px]">
            {activeTab === "circuit" ? (
              <div className="flex flex-col items-center justify-between h-full">
                <span className="absolute top-6 left-6 text-xs text-zinc-500 font-semibold tracking-wider uppercase">
                  Interactive Circuit
                </span>

                {/* SVG Circuit Visualizer */}
                <svg
                  className="w-full max-w-lg h-64 mt-8"
                  viewBox="0 0 400 200"
                >
                  {/* Wires */}
                  <path
                    d="M 100,50 L 100,150 L 300,150 L 300,50 L 250,50"
                    fill="none"
                    stroke={circuitState.switchClosed ? "#fbbf24" : "#4b5563"}
                    strokeWidth="4"
                  />
                  <path
                    d="M 100,50 L 150,50"
                  ...
                  <g transform="translate(275, 80)">
                    ...
                    <circle
                      ...
                      cy="15"
                      r="20"
                      fill={circuitState.switchClosed ? "#fbbf24" : "#1f2937"}
                      stroke="#374151"
                      strokeWidth="2"
                    />
                    <path
                      d="M 15,15 Q 25,5 35,15"
                      fill="none"
                      stroke={circuitState.switchClosed ? "#ffffff" : "#9ca3af"}
                      strokeWidth="2"
                    />
              ...
              <Interactive3DModel modelName="Human Heart" />
            ) : null}
          </div>
          ...
          <div className="bg-zinc-900/30 border border-zinc-800 rounded-3xl p-6 flex flex-col justify-between">
            <div>
              ...
              <p className="text-xs text-zinc-500 mb-6">
                Modify constants and properties to observe behavior updates.
              </p>
                  ...
                  <div className="p-4 bg-zinc-900/50 border border-zinc-800/60 rounded-2xl flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-[10px] text-zinc-500">
                        Draws current to produce light.
                      </p>
                    </div>
                    <CheckCircle
                      className={`w-5 h-5 ${circuitState.switchClosed ? "text-emerald-400" : "text-zinc-600"}`}
                    />
                  </div>
                  <div className="p-4 bg-zinc-900/50 border border-zinc-800/60 rounded-2xl flex items-center justify-between">
                    <div>
                  ...
                  <div className="p-4 bg-zinc-900/50 border border-zinc-800/60 rounded-2xl">
                    ...
                    <div className="text-xs space-y-1.5 font-mono text-zinc-400">
                      <div className="flex justify-between">
                        ...
                        <span
                          className={
                            circuitState.switchClosed ? "text-emerald-400" : ""
                          }
                        >
                          {circuitState.switchClosed ? "0.9 Amps" : "0.0 Amps"}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span>Resistance:</span> <span>10 Ohms</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="flex flex-col gap-2">
                    <button className="w-full bg-indigo-600 text-white font-medium p-3 rounded-xl transition-all">
                      Human Heart (Biology)
                    </button>
                    <button className="w-full bg-zinc-800 hover:bg-zinc-700 text-white font-medium p-3 rounded-xl transition-all border border-zinc-700">
                      V8 Engine (Physics)
                    </button>
                    <button className="w-full bg-zinc-800 hover:bg-zinc-700 text-white font-medium p-3 rounded-xl transition-all border border-zinc-700">
                ...
                <div className="bg-zinc-950 p-4 rounded-2xl border border-zinc-800 mt-4">
                  <h4 className="font-semibold text-indigo-400 mb-1 flex items-center gap-2">
                    <CheckCircle className="w-4 h-4" /> Goal
                  </h4>
                  <p className="text-sm text-zinc-400">
                    Interact with the 3D model to understand its structural
                    components.
                  </p>
                </div>
              </div>
