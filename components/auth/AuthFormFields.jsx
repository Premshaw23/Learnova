  ...
  <FieldShell label={label} error={error}>
    <div className="relative">
      ...
      <input
        ...
        className={`${fieldBaseClasses} ${Icon ? "pl-10 pr-4" : "px-4"} ${
      ...
      <div className="mt-3 rounded-xl border border-border/70 bg-muted/30 p-3">
        <div className="flex items-center justify-between gap-3 mb-3">
          <div>
            ...
            <p
              className={`text-sm font-medium ${
                strength?.textClass || "text-muted-foreground"
              }`}
            >
              {strength?.label || "Weak"}
            </p>
          ...
          <div className="h-2 w-24 rounded-full bg-border overflow-hidden">
            <div
              className={`h-full ${strength?.barClass || "bg-red-500"} ${
                strength?.widthClass || "w-0"
              }`}
            />
          </div>
        </div>
