...
export default function VolumetricPlanner() {
  ...
  if (totalWeight > STANDARD_BOX.maxWeight) {
    ...
    statusReason = `Weight limit exceeded (${totalWeight.toFixed(1)}kg / ${
      STANDARD_BOX.maxWeight
    }kg max).`;
    isOverflow = true;
  ...
  return (
    <div className="p-6 bg-white shadow rounded-lg max-w-4xl mx-auto my-6 border border-gray-200 text-gray-800">
      ...
      {/* Status Banner */}
      <div
        className={`p-4 rounded-md mb-6 font-semibold border ${
          isOverflow
      ...
      <div className="mb-6">
        ...
        <div className="w-full bg-gray-200 h-6 rounded-full overflow-hidden shadow-inner">
          <div
            ...
            className={`h-full text-center text-white text-xs flex items-center justify-center transition-all duration-500 ${
              percentageUsed > 80 ? "bg-red-500" : "bg-green-500"
            }`}
          >
