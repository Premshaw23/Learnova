        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-0">
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex flex-col gap-1.5 relative justify-center">
                <label className="text-xs uppercase font-bold tracking-[0.15em] text-slate-400">
                  Complaint Title
                </label>
                <div className="relative flex items-center">
                  <input
                    ...
                    className="w-full px-4 py-3 pr-20 text-sm rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50/90 dark:bg-slate-900/50 outline-none focus:border-indigo-500 transition text-slate-900 dark:text-slate-100"
                  />
