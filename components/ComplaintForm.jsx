    ...
    <div className="max-w-5xl mx-auto">
      <Card className="bg-white/85 dark:bg-slate-950/40 border border-white/10 dark:border-slate-800/80 rounded-[2rem] overflow-hidden shadow-2xl p-0 backdrop-blur-xl">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-0">
          ...
          <div className="md:col-span-2 flex items-center justify-between p-3.5 rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50/20 dark:bg-slate-900/10">
            <div>
