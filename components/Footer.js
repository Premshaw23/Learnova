      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16">
          ...
          <div className="space-y-5">
            ...
            <ul className="space-y-3">
              ...
              <li
                ...
                className="cursor-pointer group flex items-center gap-2 text-sm text-slate-300 hover:text-white"
              >
        ...
        <div className="mt-16 flex justify-center select-none overflow-hidden">
          {brandLetters.map((letter, i) => (
            <span
              key={i}
              className="text-[10vw] font-black text-white/5 cursor-default hover:text-purple-400/30 transition-all"
