...
export default function UniversalProfile() {
    ...
    return ( <
        ...
        <
        div className = "flex flex-col md:flex-row gap-8" > { /* Profile Image */ } <
        ...
        size = "xl"
        editable isUploading = { isUploading }
        ...
        div > {
            isEditing ? ( <
                ...
                h1 className = "text-3xl font-bold flex items-center" > { getUserDisplayName() }
        ...
        div className = "mt-6" > {
            isEditing ? ( <
                ...
                p className = "text-white/70" > { formData.bio } <
                /p>
            )
        } <
        /div>
        ...
        div className = "grid grid-cols-1 sm:grid-cols-2 gap-6 mt-8" > {
            [{
                ...
                div >
                <
                p className = "text-xs text-white/50 uppercase" > { item.label } <
                /p>

                <
                p className = "text-sm" > { item.value } <
                /p> <
                /div> <
                /div>
            ))
        ...
        div className = "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-8" > {
            [{
                ...
                <
                h3 className = "text-3xl font-bold" > { stats ? .[stat.id] || "0" } <
                /h3>

                <
                p className = "text-white/60 mt-1" > { stat.label } <
                /p> <
                /div>
            ))
        } <
            ...
            activeTab === "overview" && ( <
                ...
                div className = "space-y-4" > {
                    recentActivity.map((item) => ( <
                        ...
                        div >
                        <
                        h4 className = "font-medium" > { item.title } <
                        /h4>

                        <
                        p className = "text-sm text-white/60" > { item.time } <
                        /p> <
                        /div>

                        <
                        div className = "text-sm text-blue-400" > { item.progress } %
                        <
                        /div> <
                        /div>
                    ))
            ...
            activeTab === "activity" && ( <
                ...
                div className = "relative border-l border-white/10 ml-4 space-y-8 pb-4" > {
                    recentActivity.map((item, index) => ( <
                        ...
                        /div> <
                        p className = "text-white/70 text-sm mb-3" > { item.type === "course" && "Completed a module with excellent accuracy." } { item.type === "achievement" && "Unlocked a new milestone in your learning journey." } { item.type === "attendance" && "Successfully marked presence using GPS validation." } <
                        /p> <
...

        {
            activeTab === "settings" && ( <
                ...
                /div> <
                button onClick = {
                    () => handleToggleSetting("publicProfile") }
