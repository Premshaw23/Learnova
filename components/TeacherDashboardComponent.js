    ...
    <div className="space-y-8">
        ...
        <div className="bg-gradient-to-r from-purple-500/20 to-blue-500/20 backdrop-blur-xl rounded-2xl border border-white/20 p-6 shadow-2xl">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-right">
              <div className="text-sm text-muted-foreground dark:text-gray-400">Window closes in</div>
          ...
          {!passcodeGenerated ? (
            <button
              ...
              className="w-full bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 text-foreground dark:text-white font-bold py-3 px-6 rounded-xl transition-all duration-300 hover:scale-105 shadow-lg"
            >
            ...
            <div className="bg-black/20 rounded-xl p-4 border border-border dark:border-white/10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                {studentAttendanceData.map((student) => (
                  <div
                    key={student.id}
                    className="flex items-center justify-between bg-muted/50 dark:bg-gray-800/50 rounded-xl p-4 border border-border/50 dark:border-gray-700/50"
                  >
          ...
          {/* Exception Requests */}
          <div className="bg-card/40 dark:bg-black/40 backdrop-blur-xl rounded-2xl border border-border dark:border-white/10 ms:p-6 p-4">
            <div className="flex items-center justify-between mb-6">
              <h2 className="md:text-2xl text-sm font-bold text-foreground dark:text-white">
                Exception Requests
              </h2>
            ...
            <div className="space-y-3">
              {isLoadingRequests ? (
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-muted-foreground dark:text-gray-400 text-sm">{requestsError}</p>
                  <button
                ...
                exceptionRequests.map((request) => (
                  <div
                    key={request.id}
                    className="bg-muted/50 dark:bg-gray-800/50 rounded-xl p-4 border border-border/50 dark:border-gray-700/50"
                  >
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <div className="text-right">
                        <div className="text-foreground dark:text-white text-sm">
                          {request.className}
                        </div>
              ...
              <div className="bg-gray-900 border border-white/20 rounded-2xl p-6 max-w-4xl w-full max-h-[80vh] overflow-hidden flex flex-col">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <button
                    ...
                    className="bg-gray-700/50 hover:bg-gray-600/50 border border-gray-600 text-foreground dark:text-white p-2 rounded-lg transition-colors"
                  >
                    <X className="w-5 h-5" />
                  </button>
                </div>
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="text-right">
                            ...
                            {request.comments && (
                              <div className="text-xs text-muted-foreground dark:text-gray-300 mt-1 italic">
                                "{request.comments}"
                              </div>
                            )}
                          </div>
                ...
                <div className="mt-6 flex justify-center">
                  <button
                    onClick={() => setShowAllRequestsModal(false)}
                    className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-foreground dark:text-white px-8 py-3 rounded-xl font-medium transition-colors"
                  >
                    Close
                  </button>
                </div>
        ...
        <div className="space-y-8">
          ...
          <div className="bg-card/40 dark:bg-black/40 backdrop-blur-xl rounded-2xl border border-border dark:border-white/10 p-6">
            ...
            <div className="space-y-3">
              <button className="w-full bg-gradient-to-r from-purple-600/20 to-blue-600/20 hover:from-purple-600/30 hover:to-blue-600/30 border border-purple-500/30 text-foreground dark:text-white p-3 rounded-xl transition-colors text-left">
                <div className="flex items-center space-x-3">
              ...
              <button className="w-full bg-gradient-to-r from-blue-600/20 to-cyan-600/20 hover:from-blue-600/30 hover:to-cyan-600/30 border border-blue-500/30 text-foreground dark:text-white p-3 rounded-xl transition-colors text-left">
                <div className="flex items-center space-x-3">
          ...
          <div className="bg-gray-900 border border-white/20 rounded-2xl p-8 max-w-md w-full">
            <div className="text-center mb-6">
              <div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-blue-500 rounded-full flex items-center justify-center mx-auto mb-4">
                <Key className="w-8 h-8 text-foreground dark:text-white" />
              </div>
            ...
            <div className="bg-card/40 dark:bg-black/40 rounded-xl p-6 mb-6 text-center border border-border dark:border-white/10">
              <div className="text-sm text-muted-foreground dark:text-gray-400 mb-2">Passcode</div>
              <div className="text-4xl font-mono text-foreground dark:text-white font-bold tracking-wider mb-4">
                {currentPasscode}
              </div>
              <button
                onClick={copyPasscode}
                className="bg-white/10 hover:bg-white/20 border border-white/20 text-foreground dark:text-white px-4 py-2 rounded-lg transition-colors flex items-center space-x-2 mx-auto"
              >
                {copied ? (
                  <>
          ...
          {Object.entries(weeklySchedule).map(([day, classes]) => (
            <div key={day} className="space-y-3">
              ...
              {classes.map((cls, index) => (
                <div
                  key={index}
                  className="bg-muted/50 dark:bg-gray-800/50 rounded-lg p-3 border border-border/50 dark:border-gray-700/50"
                >
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 mt-4">
        <div className="flex space-x-1 bg-black/20 backdrop-blur-xl rounded-2xl p-1 border border-border dark:border-white/10">
          {[
            ...
            <button
              ...
              className={`flex-1 flex items-center justify-center md:space-x-2 space-x-1 md:px-4 px-2 py-3 rounded-xl font-medium transition-all duration-300 ${
                activeTab === tab.id
                  ...
                  : "text-muted-foreground dark:text-gray-400 hover:text-foreground dark:text-white hover:bg-white/5"
              }`}
            >
