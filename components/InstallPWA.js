...
export default function InstallPWA() {
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-sm sm:max-w-[360px] mx-auto bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl border border-purple-500/20 rounded-2xl shadow-2xl p-5 sm:p-6 overflow-hidden transition-all duration-300 hover:border-purple-500/40 hover:shadow-purple-500/10">
        ...
        <button
          ...
          className="absolute top-3 right-3 text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors duration-200 cursor-pointer"
        ...
        <div className="flex items-start gap-4 relative z-10">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="text-slate-900 dark:text-white font-extrabold text-base tracking-tight mb-1">
              Install Learnova
            </h3>
            <p className="text-slate-600 dark:text-slate-300 text-xs sm:text-sm leading-normal">
            ...
            <div className="flex flex-col sm:flex-row gap-2.5 mt-4">
              ...
              <button
                onClick={handleDismiss}
                className="px-4 py-2 rounded-xl bg-slate-100 dark:bg-slate-800/80 border border-slate-200 dark:border-white/5 text-slate-700 dark:text-slate-300 font-semibold text-xs hover:bg-slate-200 dark:hover:bg-slate-700/80 hover:text-slate-900 dark:hover:text-white hover:scale-[1.03] active:scale-[0.97] transition-all duration-300 cursor-pointer"
              >
                Not now
              </button>
            </div>
        ...
        <div className="mt-4 pt-4 border-t border-slate-200 dark:border-white/5 relative z-10">
          <div className="flex flex-wrap gap-x-4 gap-y-2 text-slate-500 dark:text-slate-400 text-[11px] font-medium">
