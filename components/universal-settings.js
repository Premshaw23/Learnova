...
const ToggleSwitch = ({ enabled, onChange, label, description }) => ( <
        ...
        export default function UniversalSettings() {
            ...
            const getResolvedAvatar = useCallback(
                () => resolveAvatarUrl({ user, userProfile }), [user, userProfile]
            );
            ...
            return ( <
                ...
                <
                div className = "relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8" > { /* Header */ } <
                ...
                <
                div className = "grid grid-cols-1 lg:grid-cols-4 gap-8" > { /* Sidebar Navigation */ } <
                ...
                div className = "lg:col-span-3 space-y-6" > {
                    activeSection === "profile" && ( <
                        ...
                        size = "lg"
                        editable isUploading = { isAvatarUploading }
                        ...
                        Bio <
                        /label> <
                        textarea value = { settings.profile.bio }
                        onChange = {
                            (e) =>
...

                {
                    activeSection === "notifications" && ( <
                        div className = "space-y-6" > { /* Timetable Class Reminder Card */ } <
                        SettingCard title = "Timetable & Class Reminders"
                        ...
                        Status: {
                            pushPermission === "granted" ? "Notifications Enabled" : pushPermission === "denied" ? "Notifications Blocked" : pushPermission === "unsupported" ? "Browser Unsupported" : "Permission Required"
                        } <
                        /span> <
                        /div> <
                    ...
                    activeSection === "privacy" && ( <
                        ...
                        div className = "space-y-2" > {
                            [{
                                ...
                                div >
                                <
                                p className = "text-white font-medium" > { option.label } <
                                /p> <
                                p className = "text-white/60 text-sm" > { option.desc } <
                                /p> <
                                /div> <
                                /label>
                            ))
                        ...
                        div className = "space-y-2" >
                        <
                        ToggleSwitch enabled = { settings.privacy.showProgress }
                        onChange = {
                            (value) =>
                        ...
                        >
                        <
                        ToggleSwitch enabled = { settings.privacy.showAchievements }
                        onChange = {
                            (value) =>
                        ...
                        >
                        <
                        ToggleSwitch enabled = { settings.privacy.allowMessages }
                        onChange = {
                            (value) =>
                        ...
                        >
                        <
                        ToggleSwitch enabled = { settings.privacy.dataCollection }
                        onChange = {
                            (value) =>
...

                {
                    activeSection === "learning" && ( <
                        >
                        <
                        SettingCard title = "Learning Goals"
                        ...
                        <
                        SettingCard title = "Learning Preferences"
                        ...
                        Difficulty Level <
                        /label> <
                        select value = { settings.learning.difficulty }
                        onChange = {
                            (e) =>
                            updateSetting(
                                "learning",
                        ...
                        className = "bg-slate-950 text-white" > Beginner < /option> <
                        option value = "intermediate"
                        className = "bg-slate-950 text-white" > Intermediate < /option> <
                        option value = "advanced"
                        className = "bg-slate-950 text-white" > Advanced < /option> <
                        option value = "expert"
                        className = "bg-slate-950 text-white" > Expert < /option> <
                        /select> <
                        /div>
                        ...
                        div className = "space-y-2" >
                        <
                        ToggleSwitch enabled = { settings.learning.autoplay }
                        onChange = {
                            (value) =>
                        ...
                        >
                        <
                        ToggleSwitch enabled = { settings.learning.subtitles }
                        onChange = {
                            (value) =>
...

                {
                    activeSection === "appearance" && ( <
                        SettingCard title = "Appearance & Language"
                        ...
                        div className = "grid grid-cols-3 gap-4" > {
                            [
                                ...
                                return ( <
                                    motion.button key = { themeOpt.value }
                                    onClick = {
                                        () => {
                                ...
                                : "border-white/10 bg-white/5 text-white/70 hover:text-white hover:bg-white/10 hover:border-white/20 hover:shadow-[0_0_15px_rgba(255,255,255,0.05)]"
                                  ...
                                  : "bg-white/5 group-hover:bg-white/10"
                                    ...
                                    /> <
                                    /motion.div> <
                                    span className = "text-sm font-semibold tracking-wide block" > { themeOpt.label } <
                                    /span> <
                                    /motion.button>
                                );
                            })
                        ...
                        className = "bg-slate-950 text-white" > English < /option> <
                        option value = "Spanish"
                        className = "bg-slate-950 text-white" > Español < /option> <
                        option value = "French"
                        className = "bg-slate-950 text-white" > Français < /option> <
                        option value = "German"
                        className = "bg-slate-950 text-white" > Deutsch < /option> <
                        option value = "Chinese"
                        className = "bg-slate-950 text-white" > 中文 < /option> <
                        /select> <
                        /div> <
                        div >
                        <
                        ...
                        <
                        option value = "UTC-8"
                        className = "bg-slate-950 text-white" > Pacific Time(UTC - 8) < /option> <
                        option value = "UTC-5"
                        className = "bg-slate-950 text-white" > Eastern Time(UTC - 5) < /option> <
                        option value = "UTC+0"
...

                {
                    activeSection === "data" && ( <
                        ...
                        <
                        SettingCard title = "Preference Reset"
                        ...
                        p className = "text-white/60 text-sm" >
                        Revert all configurations back to system
                        default values <
                        /p> <
                        /div> <
