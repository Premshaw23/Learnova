  ...
  const handleTogglePush = async () => {
    ...
    try {
      ...
      if (permission === "granted") {
        ...
        toast.success(
          "Timetable push notifications activated! Reminders will trigger 10m before class."
        );
                        ...
                        <div
                          className={`w-20 h-20 rounded-full border-2 ${
                            avatarPreview
                              ? "border-blue-400"
                              : "border-white/20"
                          } bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white font-bold text-xl ${
                            ...
                            >
                              <themeOpt.icon
                                className={`h-6 w-6 transition-colors duration-300 ${
                                  isSelected ? "text-white" : themeOpt.color
                                }`}
                              />
                            </motion.div>
