    ...
    <header className="w-full bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 px-6 py-4 transition-colors duration-300">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-3 self-end sm:self-center">
          ...
          <button className="px-4 py-2 bg-rose-50 hover:bg-rose-100 dark:bg-rose-950/30 dark:hover:bg-rose-950/50 text-rose-600 dark:text-rose-400 font-semibold rounded-xl text-sm border border-rose-100 dark:border-rose-950/40 active:scale-95 transition-all duration-200" aria-label="End study session">
            End Session
          </button>
        </div>
      </div>
