...
const StudentDashboard = () => {
    ...
    if (error) {
        return ( <
            ...
            <
            p className = "text-gray-400 mb-6" > { error } <
            /p>
    ...
    return ( <
        ...
        <
        div className = "text-sm text-gray-400" > { user ? .email || "No email" } <
        /div> <
        /div> <
        /div>
...
const StatCard = ({
    ...
    return ( <
        ...
        <
        div className = "text-xl font-bold" > { value } <
        /div> <
        /div>
    );
};
...
const QuickStat = ({
    ...
    <
    span className = "text-gray-300 text-sm" > { label } <
    /span> <
    /div>

    <
    span className = "text-white font-semibold" > { value } <
    /span> <
    /div>
);
...
const SecurityItem = ({
    ...
    <
    span className = "text-green-400 text-sm" > { status } <
    /span> <
    /div>
);
